    ...
    class imoveis_salvar
    {
        ...
        public function __construct()
        {
            if(isset($_GET['cod']))
            {
                ...
                $this->imovel = $this->imovel->load($this->codigo);            
            }
            else
            {
                $this->codigo = NULL;
            ...
            $this->controladorSituacao          = new controladorSituacaoImoveis();
            $this->controladorCategoria         = new controladorCategoriaImoveis();
            $this->controladorUsuario           = new controladorUsuario();
            $this->collectionSituacaoImoveis    = $this->controladorSituacao->getSituacoes();
            $this->collectionCategoriaImoveis   = $this->controladorCategoria->getCategorias();
            $this->collectionUsuarios           = $this->controladorUsuario->getUsuarios();
        }
            ...
            ?>
                ...
                <form id="imoveisForm" name='imoveisForm' action="" method="post">
                    ...
                    <fieldset>
                        ...
                        <div class='row'>
                            <div class='6u'>
                                <label for='endereco'>Codigo Interno</label>
                                <input 
                                    type='text' 
                                    id='codigoInterno' 
                                    name='codigoInterno'  
                                    ...
                                    value="<?php echo $this->imovel->codigoInterno; ?>"
                                >
                            </div>
                            <div class='6u'>
                                <label for='corretor'>Corretor</label>
                                <select id='corretor' name='corretor'>
                                    <option value=''></option>
                                    <?php
                                        foreach ($this->collectionUsuarios as $usuario) {
                                            $selectedUser = '';

                                            if($this->imovel->corretor == $usuario->codigo)
                                                $selectedUser = 'selected';

                                            echo "<option value='{$usuario->codigo}' {$selectedUser}>{$usuario->nome}</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                            <div class='6u'>
                                ...
                                <input 
                                    ...
                                    value="<?php echo $this->imovel->proprietario; ?>"
                                >
                            </div>
                            <div class='6u'>
                                <label for='telefoneProprietario'>Telefone Proprietario</label>
                                <input 
                                    type='text' 
                                    ...
                                    maxlength='17'
                                    placeholder='Telefone Proprietario'
                                    value="<?php echo $this->imovel->telefoneProprietario; ?>"
                                >
                            </div>  
                            <div class='3u'>
                    ...
                    <fieldset>
                        ...
                        <fieldset>
                            ...
                            <div class='row'>                            
                                <div class='3u'>
                                    <label for='metragemFrente'>Metragem Frente</label>
                                    <input 
                                        type='number' 
                                        id='metragemFrente' 
                                        name='metragemFrente'
                                        ...
                                        step='0.1'
                                        min='0'
                                        value='<?= $this->imovel->metragemFrente ?>'
                                    >
                                </div>
                                <div class='3u'>
                                    <label for='metragemFundos'>Metragem Fundos</label>
                                    <input 
                                        type='number' 
                                        id='metragemFundos' 
                                        name='metragemFundos'
                                        ...
                                        step='0.1'
                                        min='0'
                                        value='<?= $this->imovel->metragemFundos ?>'
                                    >
                                </div>
                                <div class='3u'>
                                    <label for='metragemEsquerda'>Metragem Esquerda</label>
                                    <input 
                                        type='number' 
                                        id='metragemEsquerda' 
                                        name='metragemEsquerda'
                                        placeholder='Metragem Esquerda'
                                        step='0.1'
                                        min='0'
                                        value='<?= $this->imovel->metragemEsquerda ?>'
                                    >
                                </div>
                                <div class='3u'>
                                    <label for='metragemDireita'>Metragem Direita</label>
                                    <input 
                                        type='number' 
                                        id='metragemDireita' 
                                        name='metragemDireita'
                                        placeholder='Metragem Direita'
                                        step='0.1'
                                        min='0'
                                        value='<?= $this->imovel->metragemDireita ?>'
                                    >
                                </div>
                                <div class='3u'>
